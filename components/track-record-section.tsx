...
const achievementIcons = [
  <Shield className="h-4 w-4" key="shield" />,
  <Star className="h-4 w-4" key="star" />,
  <AlertCircle className="h-4 w-4" key="alert" />,
  <Rocket className="h-4 w-4" key="rocket" />,
...
export function TrackRecordSection() {
  ...
  const scopeItems = [
    {
      label: t.trackRecord.scopeLabels.platforms,
      value: t.trackRecord.scopeValues.platforms,
    },
    {
      label: t.trackRecord.scopeLabels.duration,
      value: t.trackRecord.scopeValues.duration,
    },
    {
      label: t.trackRecord.scopeLabels.crashes,
      value: t.trackRecord.scopeValues.crashes,
    },
    {
      label: t.trackRecord.scopeLabels.rating,
      value: t.trackRecord.scopeValues.rating,
    },
  ];

  return (
    <section className="py-20 md:py-28" id="track-record">
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-pretty text-muted-foreground">{t.trackRecord.description}</p>
        </div>
